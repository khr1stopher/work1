...
try {
    if($x){
        echo "<div class='notification is-primary is-light'><button class='delete'></button>Documentos Enviados</div>";
    }// else {
    //     echo "<div class='notification is-danger is-light'><button class='delete'></button>Algo fallo</div>";
    // }
} catch (Exception $e) {
	...
	<div class="">
		<div class="card-k box has-text-centered">
            <div class="head">
                ...
                <h1 class="is-size-4" style="line-height: 2;margin-left: 10px;">Documentacion</h1>
            </div>
            <form action="mail.php" method="POST" onsubmit="loading_sub()">
                ...
                <button type="submit" class="button is-info is-light" id="button" onsubmit="return checkForm(this);">!Enviar</button>
                <button class="button is-info is-loading is-light" style="display: none;" id="loading">Loading</button>
            </form>  
        </div>
	</div>
</div>
